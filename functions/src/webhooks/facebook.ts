...
const facebookWebhookHttpsOptions = {
 ...
 */
export const facebookWebhookGet = onRequest(facebookWebhookHttpsOptions, async (req, res) => {
    ...
    try {
      ...
      if (lead) {
        ...
        try {
          ...
          console.warn('Auto-llamada de voz omitida (Facebook):', voiceError);
        }
      }
