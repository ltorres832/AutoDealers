...
/// Logos oficiales de redes sociales (SVG inline, sin assets externos).
class SocialIcon extends StatelessWidget {
  ...
  String? _svgFor(String platform) {
    switch (platform) {
      case 'whatsapp':
        return '''
...
<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="ig" cx="50%" cy="100%" r="100%">
