// Página de Chat Público del Dealer
...
class DealerPublicChatPage extends StatelessWidget {
  const DealerPublicChatPage({super.key});
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: hasUnread
                      ...
                      : null,
                  onTap: () => context.push('/dealer/public-chat/${conversation['id']}'),
                ),
              );
            },
          );
