...
class SellerAppointmentsPage extends StatefulWidget {
  const SellerAppointmentsPage({super.key});

  @override
  State<SellerAppointmentsPage> createState() => _SellerAppointmentsPageState();
}

class _SellerAppointmentsPageState extends State<SellerAppointmentsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authProvider.user?.tenantId != null && authProvider.user?.id != null) {
        ...
        // Cargar solo citas asignadas al seller actual
        appointmentsProvider.loadAppointments(assignedTo: authProvider.user!.id);
      }
    });
  }
