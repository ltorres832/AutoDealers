// Página de Contratos del Seller
...
class SellerContractsPage extends StatelessWidget {
  const SellerContractsPage({super.key});
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () => context.push('/seller/contracts/${contract['id']}'),
                ),
              );
            },
          );
