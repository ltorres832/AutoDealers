// Página de Gestión de Workflows (Admin)
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:go_router/go_router.dart';
import '../../../core/presentation/providers/workflows_provider.dart';

class AdminWorkflowsPage extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/admin/workflows/create'),
          ),
        ],
      ),
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => context.push('/admin/workflows/${workflow['id']}/edit'),
                ),
                onTap: () => context.push('/admin/workflows/${workflow['id']}'),
              );
            },
          );
        },
