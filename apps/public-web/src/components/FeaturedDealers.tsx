    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-50 border border-primary-100 rounded-full mb-6">
          <span className="text-primary-700 font-bold text-[10px] uppercase tracking-[0.2em]">Red Profesional</span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {featured.map((dealer) => (
          <Link
            ...
            className="group bg-white rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.12)] transition-all duration-500 border border-slate-100 hover:border-primary-400 transform hover:-translate-y-2 relative overflow-hidden"
          >
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary-50/50 rounded-bl-[4rem] -mr-8 -mt-8 transition-all duration-500 group-hover:bg-primary-100/50"></div>
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-8">
                <div className="relative">
                  ...
                  {dealer.rating && dealer.rating >= 4.5 && (
                    <div className="absolute -bottom-2 -right-2 bg-primary-600 text-white rounded-full p-1.5 shadow-lg border-2 border-white">
              ...
              {dealer.rating !== undefined && (
                <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 flex items-center justify-between mb-8 transition-colors group-hover:bg-white group-hover:border-primary-100">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 rounded-xl bg-primary-600 text-white flex items-center justify-center transition-all duration-300 group-hover:bg-primary-700 group-hover:scale-110 shadow-lg">
      ...
      <div className="text-center mt-16 flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link
          ...
          className="inline-flex items-center gap-2 group text-primary-600 font-extrabold text-sm uppercase tracking-widest hover:text-primary-700 transition-all px-8 py-4 bg-white border-2 border-primary-100 rounded-2xl hover:border-primary-600 hover:shadow-xl"
        >
          Ver concesionarios
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 group text-slate-700 font-extrabold text-sm uppercase tracking-widest hover:text-primary-700 transition-all px-8 py-4 bg-white border-2 border-slate-200 rounded-2xl hover:border-primary-600 hover:shadow-xl"
        >
          Buscar vendedores
          <svg className="w-5 h-5 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
        </Link>
