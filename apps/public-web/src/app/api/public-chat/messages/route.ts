...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Respuesta automática (FAQ, plantillas, IA o fallback)
    try {
      const { resolveInboundResponse } = await import('@autodealers/messaging');
      ...
      console.warn('Public chat auto-response skipped:', autoError);
    }
