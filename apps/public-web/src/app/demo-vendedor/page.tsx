...
export const metadata: Metadata = {
  title: 'Demo para Vendedores',
  description:
    'Descubre cómo funciona tu app de vendedor en AutoDealersOnline: inventario, página pública, leads, chats, citas y promociones.',
  alternates: {
    canonical: '/demo-vendedor',
  },
  openGraph: {
    title: 'Demo para Vendedores | AutoDealersOnline',
    description:
      'Vista previa de tu app de vendedor: publica autos, comparte anuncios y recibe clientes desde un solo panel.',
    type: 'website',
  },
};
...
const journey = [
  {
    ...
    text: 'Foto, teléfono, WhatsApp, horario y página pública profesional.',
    color: 'from-sky-500 to-cyan-400',
  },
  {
    step: '02',
    title: 'Publica autos',
    text: 'Sube fotos, precio, millaje, descripcion y detalles de cada vehiculo.',
    color: 'from-primary-600 to-red-500',
  },
  {
    step: '03',
    title: 'Comparte anuncios',
    text: 'Envia tus enlaces por WhatsApp, redes sociales, email o campanas.',
    color: 'from-amber-500 to-orange-400',
  },
  {
    step: '04',
    title: 'Atiende clientes',
    text: 'Recibe leads, chats y citas para dar seguimiento rapido.',
    color: 'from-emerald-500 to-teal-400',
  },
];

const sellerProfilePhoto =
  'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=320&q=80';

const previewCards = [
  { label: 'Mis Leads', value: '18', note: '12 activos' },
  { label: 'Mis Ventas', value: '6', note: '24.5% conversion' },
  { label: 'Revenue Mensual', value: '$48K', note: '$12K esta semana' },
  { label: 'Citas Hoy', value: '4', note: '2 mensajes sin leer' },
];

const included = [
  'Tu dashboard de vendedor',
  'Inventario con fotos',
  'Pagina publica 24/7',
  'Leads y mensajes',
  'Citas y prueba de manejo',
  'Promociones y redes',
];

const sidebarItems = [
  { name: 'Dashboard', icon: '📊' },
  { name: 'Fotos página pública', icon: '📸' },
  { name: 'Leads', icon: '📞' },
  { name: 'Interés catálogo web', icon: '👁️' },
  { name: 'Pipeline Kanban', icon: '📋' },
  { name: 'Tareas', icon: '✅' },
  { name: 'Workflows', icon: '⚙️' },
  { name: 'Inventario', icon: '🚗' },
  { name: 'Mensajes', icon: '💬' },
  { name: 'Chat Público', icon: '💬' },
  { name: 'Citas', icon: '📅' },
  { name: 'Campañas', icon: '📢' },
...
export default function DemoVendedorPage() {
  return (
    <div className="min-h-screen overflow-hidden bg-slate-50 text-slate-950">
      ...
      <DemoPreviewNotice
        registerHref="/registro?type=seller"
      ...
      <main>
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-300 sm:text-lg">
                Una vista previa de tu panel: dashboard, inventario, publicación de autos,
                leads, citas y página pública para tus clientes.
              </p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:py-16">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-slate-600">
              ...
              cuando te registras y activas tu membresía de vendedor.
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl">
            <div className="flex items-center gap-2 border-b border-slate-200 bg-slate-100 px-5 py-3">
              ...
              <span className="ml-3 rounded-full bg-white px-4 py-1 text-xs font-bold text-slate-500">
                seller.autodealers-online.com/dashboard
              </span>
            ...
            <div className="grid lg:grid-cols-[15rem_1fr]">
              <aside className="bg-slate-950 p-4 text-white sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-black">Portal Vendedor</p>
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-amber-800">
                        ...
                        activa tu membresía de vendedor.
                      </p>
                    </div>
                    <Link
                      href="/register?type=seller"
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-sm text-slate-600">
                        Esta información aparece en tu página web pública y ayuda a generar confianza.
                      </p>
                    </div>
                ...
                <div className="mb-4 rounded-2xl bg-gradient-to-br from-primary-600 to-red-600 p-5 text-white">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="mt-1 text-xl font-black">Autos de Pedro</h3>
                      <p className="text-sm text-white/85">Vendedor certificado</p>
                    </div>
                  </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-slate-600">
                Conoce cómo funciona tu app antes de elegir una membresía:
                inventario, página pública, leads, chats, citas y promoción en redes.
              </p>
        ...
        <section className="px-4 py-14 sm:py-16">
          <div className="mx-auto max-w-5xl rounded-[2rem] bg-gradient-to-br from-primary-700 to-red-600 p-7 text-center text-white shadow-2xl sm:p-10">
            ...
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">
              Vende en línea con tu propio panel de vendedor.
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-white/90 sm:text-base">
              Publica autos, comparte anuncios, recibe leads y atiende clientes desde
              AutoDealersOnline. Tu inventario online, profesional y disponible 24/7.
            </p>
