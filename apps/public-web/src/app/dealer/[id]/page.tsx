      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <div className="text-center">
            ...
            <div className="space-y-3 mb-6 text-sm">
              ...
              {(dealer.whatsapp || dealer.phone) && (
                <div className="flex items-center justify-center gap-2 text-gray-700">
                  ...
                  <a 
                    href={buildWhatsAppHref(dealer.whatsapp || dealer.phone) || '#'}
                    target="_blank" 
            ...
            <div className="flex gap-2 justify-center flex-wrap">
              ...
              {dealer.whatsapp && (
                <a
                  href={buildWhatsAppHref(dealer.whatsapp) || '#'}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {dealer.phone && (
                <a
                  href={buildTelHref(dealer.phone) || '#'}
                  className="bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 font-medium flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {dealer.tenantId ? (
                <a
                  href={`/${encodeURIComponent(dealer.tenantId)}/vender`}
                  className="bg-amber-500 text-white px-6 py-3 rounded-lg hover:bg-amber-600 font-medium"
                >
                  Vender tu auto
                </a>
              ) : null}
        ...
        {sellers.length > 0 && (
          <div className="bg-white rounded-lg shadow-lg p-5 sm:p-6 mb-8">
            <h2 className="text-2xl font-bold mb-5 text-gray-900">Nuestros Vendedores ({sellers.length})</h2>
              ...
              {sellers.map((seller) => {
                ...
                return (
                  <Link
                    ...
                    className="border-2 rounded-xl p-4 hover:shadow-lg transition-all border-gray-200 hover:border-primary-500 bg-white group cursor-pointer"
                  >
                    <div className="text-center">
                      {/* Foto del vendedor */}
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary-500 to-brand-red-bright600 flex items-center justify-center overflow-hidden mx-auto mb-3 border-4 border-white shadow-lg group-hover:scale-105 transition-transform">
                        {seller.photo ? (
                          <img
                            src={seller.photo}
                            alt={seller.name}
                            ...
                            onError={(e) => {
                              ...
                              if (parent) {
                                parent.innerHTML = `<span class="text-2xl text-white font-bold">${seller.name.charAt(0).toUpperCase()}</span>`;
                              }
                            }}
                          />
                        ) : (
                      ...
                      {/* Nombre y título */}
                      <h3 className="font-bold text-lg text-gray-900 mb-1 group-hover:text-primary-600 transition">{seller.name}</h3>
                      <p className="text-xs text-gray-600 mb-2">{seller.title || 'Vendedor'}</p>
                      ...
                      <div className="mb-3">
                        {seller.sellerRating > 0 ? (
                          ...
                          <div className="flex items-center justify-center gap-2 text-xs text-gray-400 py-1.5">
                      ...
                      <div className="space-y-2 pt-3 border-t border-gray-200 mb-3">
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <div className="bg-gradient-to-r from-primary-600 to-brand-red-bright600 text-white py-2 rounded-lg font-medium text-xs group-hover:from-primary-700 group-hover:to-brand-red-bright700 transition-all flex items-center justify-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {vehicles.map((vehicle) => {
                ...
                >
                  ...
                  <div className="p-3">
                    <h3 className="font-bold text-base mb-1.5 group-hover:text-primary-700">
                    ...
                    <div className="px-3 pb-3 flex gap-1.5">
                      {dealer.email && (
                        <button
                          ...
                          className="flex-1 bg-primary-600 text-white px-3 py-1.5 rounded hover:bg-primary-700 font-medium text-xs flex items-center justify-center gap-1"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                      ...
                      {dealer.phone && (
                        <a
                          href={buildTelHref(dealer.phone) || '#'}
                          className="flex-1 bg-green-600 text-white px-3 py-1.5 rounded hover:bg-green-700 font-medium text-xs text-center flex items-center justify-center gap-1"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
