...
function RegisterPageContent() {
  ...
  if (step === 1) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center py-20 px-4 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 -mr-40 -mt-40 w-[600px] h-[600px] bg-primary-100/40 rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-[500px] h-[500px] bg-primary-100/40 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <div className="max-w-6xl w-full relative z-10">
          <div className="text-center mb-16 px-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-50 border border-primary-100 rounded-full mb-6">
              <span className="text-primary-600 font-extrabold text-[10px] uppercase tracking-[0.3em]">Comienza tu Legado</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-6 tracking-tight">
              Únete a la Red <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-600">Premium</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div
              ...
              className="group relative bg-white rounded-[3.5rem] p-10 md:p-14 cursor-pointer shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_50px_100px_-20px_rgba(225, 6, 0,0.15)] transition-all duration-700 border border-slate-100 hover:border-primary-200 hover:-translate-y-4 flex flex-col items-center text-center overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-40 h-40 bg-primary-50 rounded-bl-full -z-0 group-hover:scale-150 transition-transform duration-1000 opacity-50"></div>

              <div className="relative z-10 w-28 h-28 bg-gradient-to-br from-primary-600 to-primary-700 rounded-[2.5rem] flex items-center justify-center text-5xl mb-10 shadow-2xl shadow-primary-500/30 group-hover:rotate-6 transition-transform duration-500">
                🏢
              </div>

              <h3 className="relative z-10 text-3xl font-black text-slate-900 mb-4 tracking-tight group-hover:text-primary-600 transition-colors">Concesionario</h3>
                ...
                <ul className="text-left space-y-4">
                  {REGISTER_DEALER_FEATURES.map((feat) => (
                    <li key={feat} className="flex items-center gap-2 text-xs font-semibold text-slate-700">
                      <span className="w-4 h-4 rounded-full bg-primary-100 text-primary-600 flex items-center justify-center flex-shrink-0 text-[10px]">
                        ✓
                      </span>
                      {feat}
                    </li>
              ...
              <div className="mt-auto w-full flex flex-col items-center gap-6">
                <div className="w-full h-16 relative flex items-center justify-center group/btn overflow-hidden rounded-2xl bg-primary-600 shadow-xl shadow-primary-600/20 active:scale-95 transition-transform">
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-700 to-primary-600 translate-y-full group-hover/btn:translate-y-0 transition-transform duration-500"></div>
            ...
            >
              <div className="absolute top-0 left-0 w-40 h-40 bg-primary-50 rounded-br-full -z-0 group-hover:scale-150 transition-transform duration-1000 opacity-50"></div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-20 px-4 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(225, 6, 0,0.05),transparent_50%)]"></div>
      ...
      <div className="max-w-xl w-full bg-white rounded-[4rem] shadow-[0_40px_100px_-25px_rgba(0,0,0,0.12)] p-12 md:p-16 relative z-10 border border-slate-100">
        <div className="mb-12">
          <button onClick={() => setStep(1)} className="group flex items-center gap-3 text-slate-400 hover:text-primary-600 font-black text-[10px] uppercase tracking-[0.2em] mb-10 transition-colors">
            <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-primary-50 group-hover:-translate-x-1 transition-all">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex items-start gap-4 px-2">
              <div className="pt-1">
                <input
                  ...
                  className="w-5 h-5 rounded-lg border-2 border-slate-200 text-primary-600 focus:ring-primary-600/20 transition-all cursor-pointer"
                  required
                />
              </div>
              <label htmlFor="terms" className="text-[11px] font-bold text-slate-500 leading-relaxed cursor-pointer select-none">
                ...
                <Link href="/terminos" className="text-primary-600 hover:text-primary-700 underline underline-offset-4">
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={loading}
              className="w-full group bg-primary-600 text-white h-20 rounded-[2rem] font-black text-xs uppercase tracking-[0.4em] relative overflow-hidden shadow-2xl hover:bg-primary-700 transition-all duration-500 disabled:opacity-50 active:scale-[0.98]"
            >
          ...
          <p className="text-center text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
            ¿Ya tienes acceso? <Link href="/login" className="text-primary-600 hover:text-primary-700 transition-colors underline underline-offset-4">Inicia Sesión</Link>
          </p>
        </form>
      </div>
    </div>
