    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {websiteSettings?.hero?.title ? (
        <section
          ...
          style={{
            background: 'linear-gradient(135deg, #7c3aed 0%, #4f46e5 45%, #be185d 100%)',
          }}
        >
          ...
          {vehicles.length === 0 ? (
            ...
            <div className="space-y-12">
              ...
              {inventoryByMakeModel.map((makeGroup) => (
                ...
                >
                  <h3 className="text-2xl font-bold text-gray-900 border-b-2 border-purple-200 pb-2 mb-6">
                    {makeGroup.make}
                  </h3>
                  <div className="space-y-10">
                    {makeGroup.models.map((modelGroup) => (
                      <div key={`${makeGroup.slug}::${modelGroup.slug}`}>
                        <h4 className="text-lg font-semibold text-purple-900 mb-4 flex flex-wrap items-baseline gap-2">
                          ...
                          <div className="space-y-8">
                            {modelGroup.variants.map((variant) => (
                              <div key={variant.slug}>
                                <h5 className="text-base font-medium text-gray-800 mb-3 pl-3 border-l-4 border-purple-300">
                                  {variant.label}
