...
/**
 * Comprueba membresía por tenantId (sin re-leer el request). Devuelve NextResponse 403 si no aplica, o null si OK.
 * Patrón: `const g = await requireTenantFeature(tenantId, 'useFIModule'); if (g) return g;`
 */
