        ...
        <div className="p-6">
                ...
                {plans.map((plan) => (
                  ...
                  >
                    ...
                    <ul className="space-y-2 mb-6">
                      {plan.features.maxSellers && (
                        <li className="flex items-center text-sm">
                          <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                          </svg>
                          {plan.features.maxSellers === null ? 'Vendedores ilimitados' : `Hasta ${plan.features.maxSellers} vendedores`}
                        </li>
                      )}
                      {plan.features.maxInventory && (
                        <li className="flex items-center text-sm">
                          <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                          </svg>
                          {plan.features.maxInventory === null ? 'Inventario ilimitado' : `Hasta ${plan.features.maxInventory} vehículos`}
                        </li>
                      )}
          ...
          <div className="mt-6 p-4 bg-primary-50 rounded-lg">
            <div className="flex items-start">
              <svg className="w-6 h-6 text-primary-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div>
                <h4 className="text-sm font-semibold text-primary-900">💡 ¿Necesitas ayuda?</h4>
                <p className="text-sm text-primary-700 mt-1">
                  Contáctanos para obtener asesoría personalizada sobre qué plan es mejor para tu negocio.
                </p>
              </div>
            </div>
          </div>
