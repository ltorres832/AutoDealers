...
export interface VehicleInventoryCardProps {
  ...
  onShare?: (vehicle: RealtimeInventoryVehicle) => void;
  onDacoLabel?: (vehicle: RealtimeInventoryVehicle) => void;
}
...
export default function VehicleInventoryCard({
  ...
  async function handleGenerateVideo() {
    ...
    setBusy(true);
    try {
      const res = await fetchWithAuth(`/api/vehicles/${vehicle.id}/generate-video`, {
        method: 'POST',
      });
