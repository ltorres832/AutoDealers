...
export default function BrandingSettingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Branding Personalizado</h2>
        <p className="text-gray-600">
          Personaliza el logo y favicon de tu dashboard y página web pública
        </p>
      </div>
          ...
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Formatos: PNG, JPG, SVG. Tamaño máximo: 5MB. Recomendado: 200x60px
              </p>
              {currentLogo && (
                <button
                  type="button"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              />
              <p className="mt-2 text-xs text-gray-500">
                Formatos: PNG, ICO, SVG. Tamaño máximo: 1MB. Recomendado: 32x32px o 64x64px
              </p>
              {currentFavicon && (
                <button
                  type="button"
