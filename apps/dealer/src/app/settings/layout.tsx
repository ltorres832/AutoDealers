...
const NAV = [
  ...
  { href: '/settings/integrations', label: 'Integraciones', match: (p: string) => p.startsWith('/settings/integrations') && !p.includes('/api') },
  { href: '/settings/integrations/api', label: 'API / Connect', match: (p: string) => p.startsWith('/settings/integrations/api') },
  { href: '/settings/migration', label: 'Migración CSV', match: (p: string) => p.startsWith('/settings/migration') },
  { href: '/settings/payments', label: 'Pagos', match: (p: string) => p.startsWith('/settings/payments') },
  { href: '/settings/compensation', label: 'Compensación', match: (p: string) => p.startsWith('/settings/compensation') },
  ...
  { href: '/settings/trust-gallery', label: 'Fotos públicas', match: (p: string) => p.startsWith('/settings/trust-gallery') },
