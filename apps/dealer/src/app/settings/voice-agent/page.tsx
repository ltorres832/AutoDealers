  ...
  if (!membership?.voiceAIEnabled) {
    return (
      <MembershipUpsell
        ...
        description="Con esta función, un agente con voz humana atiende y hace llamadas de seguimiento a tus clientes, agenda citas y registra todo en tu CRM con grabación y transcripción. Actívalo mejorando tu membresía."
        backHref="/settings"
