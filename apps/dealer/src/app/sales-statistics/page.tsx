    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {statistics && (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {statistics.bySeller.map((seller) => (
                      <tr key={seller.sellerId} className="border-b hover:bg-gray-50">
                        <td className="py-3 px-4">{seller.sellerName || 'Sin nombre'}</td>
                        ...
                        <td className="text-right py-3 px-4 text-gray-600">
                          ${seller.sales > 0 ? (seller.revenue / seller.sales).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00'}
                        </td>
                      </tr>
                    ))}
                  </tbody>
          ...
          {/* Gráfico por Día (si está disponible) */}
