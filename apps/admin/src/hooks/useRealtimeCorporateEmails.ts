...
/** Admin: todos los corporate emails vía collectionGroup */
export function useRealtimeCorporateEmailsAdmin() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      collectionGroup(db, 'corporate_emails'),
      (snapshot) => {
...
/** Dealer/seller: emails del tenant */
