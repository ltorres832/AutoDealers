...
export default function AdminLayout({
  ...
  const menuItems = [
      ...
      { href: '/admin/vin-conflicts', label: 'Conflictos VIN', icon: '🔎' },
      ...
      { href: '/admin/settings/security', label: 'Mi contraseña', icon: '🔒' },
      ...
      { href: '/admin/daco-labels', label: 'Etiquetas DACO', icon: '🏷️' },
