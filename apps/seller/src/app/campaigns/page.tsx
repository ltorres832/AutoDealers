  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">Mis Campañas de Publicidad</h1>
          <p className="text-gray-600 mt-2">
            Crea y gestiona tus campañas de marketing para promocionar tus vehículos.
          </p>
        </div>
        <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Para publicar automáticamente en Facebook/Instagram al guardar, elige estado Activa (con la casilla de redes
              activada).
            </p>
          </div>
          ...
          {(formData.platforms.includes('facebook') || formData.platforms.includes('instagram')) &&
            ...
            <label className="flex cursor-pointer items-start gap-2 rounded-lg border border-primary-100 bg-primary-50/50 p-3">
              ...
              />
              <span className="text-sm text-gray-800">
                <strong>Publicar en redes al guardar</strong> (Facebook / Instagram) solo si el estado es{' '}
                <strong>Activa</strong>. Con borrador, usa «Publicar en redes» en la tarjeta. Requiere integración en
                Configuración; Instagram exige imagen.
              </span>
            </label>
          )}
