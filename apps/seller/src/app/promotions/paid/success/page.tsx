...
function PaidPromotionSuccessPageContent() {
            ...
            {promotionInfo && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
                ...
                <div className="space-y-1 text-sm">
                  <div><strong>Tipo:</strong> {promotionInfo.promotionScope === 'vehicle' ? 'Vehículo' : 'Vendedor'}</div>
...
export default function PaidPromotionSuccessPage() {
  return (
    <Suspense fallback={
      ...
      <PaidPromotionSuccessPageContent />
    </Suspense>
  );
}
