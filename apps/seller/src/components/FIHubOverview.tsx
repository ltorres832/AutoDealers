...
export default function FIHubOverview() {
  return (
    <section className="mb-10 overflow-hidden rounded-2xl border border-primary-100 bg-gradient-to-br from-slate-50 via-primary-50/60 to-primary-50 shadow-sm">
      <div className="border-b border-primary-100/80 bg-white/70 px-5 py-5 md:px-8 md:py-6 backdrop-blur-sm">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-wide text-primary-600">Centro F&amp;I</p>
          ...
          <div className="flex w-full flex-col gap-2 sm:flex-row lg:w-auto lg:flex-col lg:items-stretch">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-xl border border-primary-600 bg-white px-4 py-2.5 text-sm font-semibold text-primary-700 shadow-sm hover:bg-primary-50"
            >
              + Cliente avanzado
            </Link>
            <Link
