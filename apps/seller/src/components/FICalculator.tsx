...
interface FinancingCalculationResult {
          ...
          {calculation.affordability !== 'affordable' && (
            <div className={`mt-3 p-2 rounded text-sm ${
              ...
              {calculation.affordability === 'tight' 
                ? '⚠️ El pago mensual es ajustado. Considera aumentar el pronto pago o extender el plazo.'
                : '⚠️ El pago mensual puede ser difícil de mantener. Se recomienda aumentar el pronto pago significativamente.'}
            </div>
          )}
        </div>
      )}
