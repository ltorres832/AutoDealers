...
export type Placement = 'hero' | 'sidebar' | 'sponsors_section' | 'between_content' | 'vehicle_page';
...
> = {
  banner: {
    ...
    vehicle_page: { 7: 90, 15: 160, 30: 280 },
  },
  promotion: {
    ...
    vehicle_page: { 7: 110, 15: 190, 30: 330 },
  },
  sponsor: {
    ...
    vehicle_page: { 7: 160, 15: 280, 30: 470 },
  },
};
