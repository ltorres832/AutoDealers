...
exports.generatePDFWithBranding = generatePDFWithBranding;
exports.generatePurchaseCertificate = generatePurchaseCertificate;
 ...
 */
async function generatePDFWithBranding(options) {
    const { tenantId, userId, documentType, content, includeQR, qrData } = options;
    // Obtener configuración de branding
    const brandingConfig = await (0, document_branding_1.getDocumentTypeBranding)(tenantId, documentType, userId);
    const brandingElements = await (0, document_branding_1.getOrderedBrandingElements)(tenantId, documentType, userId);
 ...
 */
async function generatePurchaseCertificate(tenantId, purchaseId, userId) {
 ...
 */
async function generateContract(tenantId, contractId, userId) {
