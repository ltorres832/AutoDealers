...
exports.ZohoMailService = void 0;
class ZohoMailService {
    constructor(clientId, clientSecret, refreshToken, domain, organizationId) {
    ...
    async createEmailAccount(account) {
        try {
            ...
            const response = await fetch(`https://mail.zoho.com/api/accounts/${this.organizationId}/users`, {
                method: 'POST',
                headers: {
     ...
     */
    async suspendEmailAccount(emailId) {
        try {
            const accessToken = await this.getAccessToken();
            const response = await fetch(`https://mail.zoho.com/api/accounts/${this.organizationId}/users/${emailId}/status`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Zoho-oauthtoken ${accessToken}`,
                    'Content-Type': 'application/json',
     ...
     */
    async activateEmailAccount(emailId) {
        try {
            const accessToken = await this.getAccessToken();
            const response = await fetch(`https://mail.zoho.com/api/accounts/${this.organizationId}/users/${emailId}/status`, {
                method: 'PUT',
     ...
     */
    async deleteEmailAccount(emailId) {
        try {
            const accessToken = await this.getAccessToken();
            const response = await fetch(`https://mail.zoho.com/api/accounts/${this.organizationId}/users/${emailId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Zoho-oauthtoken ${accessToken}`,
                },
    ...
    async resetPassword(emailId, newPassword) {
        try {
            const accessToken = await this.getAccessToken();
            const response = await fetch(`https://mail.zoho.com/api/accounts/${this.organizationId}/users/${emailId}/password`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Zoho-oauthtoken ${accessToken}`,
                    'Content-Type': 'application/json',
     ...
     */
    async createEmailAlias(emailId, alias) {
        try {
            const accessToken = await this.getAccessToken();
            const response = await fetch(`https://mail.zoho.com/api/accounts/${this.organizationId}/users/${emailId}/aliases`, {
                method: 'POST',
                headers: {
                    'Authorization': `Zoho-oauthtoken ${accessToken}`,
                    'Content-Type': 'application/json',
